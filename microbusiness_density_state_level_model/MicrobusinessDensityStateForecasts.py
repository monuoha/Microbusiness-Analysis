...
app = FastAPI(title = 'Microbusiness Density State-Level Forecasting Service')

with open('microbusiness_density_state_level_model.pkl', 'rb') as f:
    model = pickle.load(f)
...
def predict(request: ForecastRequest):
    try:
        ...
        x1 = np.load('engagement_index_state.npy')
